"""MCP client: connects to MCP servers and wraps their tools as native ghostbot tools."""
...
from ghostbot.agent.tools.base import Tool
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a ghostbot Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only ghostbot Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only ghostbot Tool."""
