...
RESTART_NOTIFY_CHANNEL_ENV = "ghostbot_RESTART_NOTIFY_CHANNEL"
RESTART_NOTIFY_CHAT_ID_ENV = "ghostbot_RESTART_NOTIFY_CHAT_ID"
RESTART_STARTED_AT_ENV = "ghostbot_RESTART_STARTED_AT"
