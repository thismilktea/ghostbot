...
_TOOL_FORMATS: dict[str, tuple[list[str], str, bool, bool]] = {
    "read_file":     (["path", "file_path"],              "Reading {}",     True,  False),
    "write_file":    (["path", "file_path"],              "Writing {}",     True,  False),
    "edit":          (["file_path", "path"],              "Editing {}",     True,  False),
    "edit_file":     (["path", "file_path"],              "Editing {}",     True,  False),
    "notebook_edit": (["path", "notebook_path"],          "Editing notebook {}", True, False),
    "glob":          (["pattern"],                        'Globbing "{}"',   False, False),
    "grep":          (["pattern"],                        'Searching "{}"', False, False),
    "exec":          (["command"],                        "Running {}",        False, True),
    "web_search":    (["query"],                          'Searching web "{}"', False, False),
    "web_fetch":     (["url"],                            "Fetching {}",    True,  False),
    "list_dir":      (["path"],                           "Listing {}",       True,  False),
}
