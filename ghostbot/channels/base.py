...
class BaseChannel(ABC):
    ...
    Each concrete channel should implement this interface to integrate with the
    ghostbot message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from ghostbot.providers.transcription import OpenAITranscriptionProvider
                provider = OpenAITranscriptionProvider(api_key=self.transcription_api_key)
            else:
                from ghostbot.providers.transcription import GroqTranscriptionProvider
